...
## Overview
This track aims to determine and implement a safe, deterministic installation strategy for `promptfoo` (https://github.com/promptfoo/promptfoo) within the project's existing dotfiles/chezmoi/bazel ecosystem.
