...
dependencyResolutionManagement {
  versionCatalogs {
    create("libs") {
      ...
      version("kotlinxCoroutines", "1.5.0")
      version("kotlinxDatetime", "0.2.0")
      version("ktor", "1.5.4")
      ...
      alias("kotlinPoet").to("com.squareup:kotlinpoet:1.8.0")
    ...
    create("testLibs") {
      ...
      version("junit.platform", "1.7.2")
      version("minutest", "1.13.0")
      version("mockk", "1.11.0")
      version("strikt", "0.31.0")
