...
description: >-
  Enforces minimal context in agent configuration files like AGENTS.md,
  CLAUDE.md, GEMINI.md, and *.mdc to improve task success rates and reduce
  inference costs. Use when writing or modifying agent context files.
---
# Write agent context
