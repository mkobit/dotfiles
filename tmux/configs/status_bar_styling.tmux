...
set -g window-status-format " #[fg=#81a1c1,bold]#I#[fg=#81a1c1,nobold]:#[fg=#d8dee9]#{window_name}#{?#{m:*ssh*,#{pane_current_command}}, [SSH],}#{?window_zoomed_flag, 🔍,} #F "
set -g window-status-current-format " #[fg=#2e3440,bg=#88c0d0,bold]#I#[fg=#2e3440]:#[fg=#2e3440,bold]#{window_name}#{?#{m:*ssh*,#{pane_current_command}}, [SSH],}#{?window_zoomed_flag, 🔍,} #F "
...
set -g window-status-format " #I:#W #{?#{m:*ssh*,#{pane_current_command}},#[fg=#bf616a]SSH#[fg=#81a1c1],}#F "
set -g window-status-current-format " #I:#W #{?#{m:*ssh*,#{pane_current_command}},#[fg=#bf616a]SSH,}#F "
