...
def test_push():
    push = c.Push(auto_setup_remote=True, default="upstream", follow_tags=True, gpg_sign='if-asked', recurse_submodules="only", use_force_if_includes=True, negotiate=True)
