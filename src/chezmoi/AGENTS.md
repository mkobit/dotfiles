...
- Antigravity's `permissions.allow` is union-merged with whatever's already live rather than replaced, because agy's own in-CLI "always allow" flow writes grants into that same array. Claude's is fully replaced.
