...
{{ if and (eq $prompt "oh-my-zsh") (eq $installation "external-sources") .powerlevel10k.enabled }}
# Generated by Powerlevel10k configuration wizard on 2025-09-17 at 14:03 CDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 57817.
# Wizard options: flat, large icons, classic, unicode, dark, 24h time, flat heads,
# flat tails, 1 line, compact, many icons, concise, transient_prompt,
