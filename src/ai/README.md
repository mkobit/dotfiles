...
Two kinds of skills share one catalog namespace: `src/chezmoi/.chezmoidata/ai/skills/*.toml` contains shared settings and provider-specific external sources.
