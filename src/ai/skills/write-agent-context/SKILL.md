...
description: Enforces minimal, progressively-disclosed context in agent configuration files like AGENTS.md, GEMINI.md, SKILL.md, and *.mdc to improve task success rates and reduce inference costs. Use when writing or modifying agent context files or skills.
metadata:
...
The same restraint applies to skills (`SKILL.md`), not just `AGENTS.md`/`GEMINI.md`.
