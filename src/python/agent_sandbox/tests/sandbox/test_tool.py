...
def test_claude_gets_dangerously_skip_permissions():
    cmd, env = adapt_command(["claude", "--print", "hi"], {})
...
def test_opencode_sets_config_env():
    cmd, env = adapt_command(["opencode"], {})
