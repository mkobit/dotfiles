"""
Macros for portable Agent Skills drift testing.

Generates diff_test targets that compare canonical skills against
their committed copies in each tool's chezmoi source directory.
"""
