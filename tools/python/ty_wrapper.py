...
if __name__ == "__main__":
    ...
    try:
        ...
        # ty file=.../ty.runfiles/rules_python++pip+pypi_314_ty/site-packages/ty/__init__.py
        ...
        if not bin_path:
            print("Could not find ty binary via ty module or PATH (avoided expensive glob).", file=sys.stderr)
            sys.exit(1)
